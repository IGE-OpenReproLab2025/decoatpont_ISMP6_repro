...
for simu, nb_exp in simulation.items():
    ...
    for i, exp in enumerate(exp_list):
        ...
        if simu == 'ULB_fETISh-KoriBU2':
            ds_vx = xr.open_dataset(f'/home/jovyan/private-storage/simu/ULB_fETISh-KoriBU2/{exp}/xvelmean_AIS_ULB_fETISh-KoriBU2_{exp}.nc', decode_times = False)
            ds_vy = xr.open_dataset(f'/home/jovyan/private-storage/simu/ULB_fETISh-KoriBU2/{exp}/yvelmean_AIS_ULB_fETISh-KoriBU2_{exp}.nc', decode_times = False)
        else:
        ...
        for time in range (len(ds_orog.time)):
            ...
            # === Save NetCDF ===
            nc_path = f'/home/jovyan/private-storage/result/ligroundf_{simu}_{exp}.nc'
