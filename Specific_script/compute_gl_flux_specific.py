...
target_simu = input("Enter the simulation name (e.g., DC_ISSM): ")
target_exp = input("Enter the experiment name (e.g., expAE01): ")
target_year = int(input("Enter the year (e.g., 2250): "))
